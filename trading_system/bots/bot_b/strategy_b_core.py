...
class L2Gate:
    ...
    def check_entry_pattern(
        ...
        l1_passed: bool,
        bar_index: int
    ) -> Tuple[bool, str, Optional[StrategyBSignal]]:
    ...
    def _generate_signal(self, entry_price, setup, ema9, ema20, ema20_series=None) -> Optional[StrategyBSignal]:
    ...
    def _generate_signal_short(self, entry_price, setup, ema9, ema20, ema20_series=None) -> Optional[StrategyBSignal]:
