...
from config_c import get_strategy_c_config
from strategy_c_core import StrategyCCore
...
class StrategyCBot:
    ...
    def __init__(self):
        logger.info("="*60)
        logger.info("⚡ Strategy C Bot 高報酬版 初始化")
        logger.info("="*60)
        
        self.config = get_strategy_c_config()
